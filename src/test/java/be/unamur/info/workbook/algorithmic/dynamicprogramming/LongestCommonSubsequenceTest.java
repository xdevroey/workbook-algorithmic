...
/**
 * Unit tests for LongestCommonSubsequence class.
 * @author Xavier Devroey - xavier.devroey@unamur.be
 */
public class LongestCommonSubsequenceTest {
    
    private static final Logger LOG = LoggerFactory.getLogger(LongestCommonSubsequenceTest.class);
    ...
    public void testLongestSizeDifferentSequences() {
        ...
        LongestCommonSubsequence<Character> longestCommon;
        longestCommon = new LongestCommonSubsequence(seq1, seq2);
    ...
    public void testLongestSizeSameSequences() {
        ...
        LongestCommonSubsequence<Character> longestCommon;
        longestCommon = new LongestCommonSubsequence(seq1, seq1);
